...
var scope = {
    ...
    list_l:[
        ...
        {name:'傅煜铭',college:'中国地质大学',major:'地球物理专业',intro:'北京市优秀毕业生',img:'傅煜铭.png'},
        ...
        {name:'高子纹',college:'北京第二外国语学院',major:'******',intro:'优秀学生干部',img:'高子纹.png'},
        ...
        {name:'梁煊',college:'厦门大学',major:'财政学',intro:'专业第三的成绩保送至中国人民大学财政金融学院硕博连读',img:'梁煊.png'},
        ...
        {name:'刘婉莹',college:'中国传媒大学',major:'广播影视编导',intro:'=============',img:'刘婉莹.png'},
        ...
        {name:'鹿飞宇',college:'北京师范大学',major:'=======',intro:'心理学部,交响乐团团长，用心理学解读人生',img:'鹿飞宇.png'},
        ...
        {name:'孟瑶玥',college:'上海财经大学',major:'生态学',intro:'长期保持专业第一的成绩',img:'孟瑶玥.png'},
        ...
        {name:'邱飞旸',college:'清华大学',major:'工业工程',intro:'高中时一个月从年级300到年级第7',img:'邱飞旸.png'},
        {name:'任小康',college:'四川大学',major:'高分子材料科学与工程',intro:'现中科院研究生一年级',img:'任小康.png'},
        ...
        {name:'孙静如',college:'南京农业大学',major:'生物科学',intro:'曾南非德班国际气候大会与会候选人',img:'孙静如.png'},
        {name:'孙圣',college:'山东林业大学',major:'林学',intro:'登山、跑步、旅游、积极乐观向上',img:'孙圣.png'},
        {name:'孙瑀蔓',college:'北京大学',major:'中文',intro:'曾作为中国学生代表参加美国西点军校领导力论坛',img:'孙瑀蔓.png'},
        {name:'孙舟',college:'中国人民大学',major:'精算学',intro:'从芬兰交换归来，喜欢极光、大自然美景、画画、户外运动',img:'孙舟.png'},
        {name:'覃红晔',college:'中国人民大学',major:'============',intro:'以皮毛的态度热爱各种非主业',img:'覃红晔.png'},
        {name:'唐定耀',college:'北京语言大学',major:'============',intro:'北京语言大学校级“优秀团员”“三好学生”',img:'唐定耀.png'},
        ...
        {name:'王璨',college:'北京语言大学',major:'国际事务与国际关系',intro:'大三时被评为雅思口语最年轻讲师',img:'王璨.png'},
        ...
        {name:'杨千帆',college:'清华大学五道口金融学院',major:'=========',intro:'专业排名第一，获得宝钢优秀学生奖学金',img:'杨千帆.png'},
